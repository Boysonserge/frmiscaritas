    ...
    <div class="auto-container">
        <div class="widget-wrapper">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 contact-widget footer-widget">
                    ...
                    <ul>
                        <li>MUHANGA-Kabgayi Street,  <br>Across, Health Center.</li>
                        <li><a href="mailto:support@goodsoul.com">support_Caritas@gmail.com </a></li>
                    </ul>
                    <h3><a href="tel:+250 788 842 389">+250 788 842 380</a></h3>
                </div>
                <!-- About Widget -->
        ...
        <div class="footer-bottom">
            <div class="left-content">
                <div class="icon"><img src="images/resource/logo-icon12.png" alt=""></div>
                <div class="copyright-text"><a href="templateshub.net">CARITAS DIOCESE KABGAYI</a><br>Designed By <a href="#">ThiSe.</a></div>
            </div>
