                    ...
                    <div class="p-6 sm:p-8">
                        <form method="POST" action="{{ route('login') }}">
                          ...
                          217 -10 16 -14 14 -45 -18z"></path>
                                        ...
                                        </svg><span class="text-gray-700 dark:text-gray-200">{{env('APP_FRMIS')}}</span></h2>
                                </a>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <input name="email" id="inputemail" :value="old('email')" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" aria-label="email" type="email" required="">
                            </div>
                            <div class="mb-6">
                                <div class="flex flex-wrap flex-row">
                                    ...
                                    <div class="flex-shrink max-w-full w-1/2 ltr:text-right rtl:text-left">
                                        <a class="hover:text-blue-700" href="">Forgot password?</a>
                                    </div>
                                </div>
                                <input id="inputpass" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" aria-label="password" type="password" autocomplete="current-password" name="password" required="">
                            </div>
                            <div class="mb-6">
                                <input id="remember_me" type="checkbox" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none" name="remember">
