<nav id="sidebar-menu" x-description="Mobile menu" x-bind:aria-expanded="open"
    ...
    <div class="h-full overflow-y-auto scrollbars">
        ...
        <ul id="side-menu" x-data="{selected:1}"
            ...
            <li>
                <a class="block py-2.5 px-6 hover:text-indigo-500 dark:hover:text-gray-300" href="{{route('dashboard')}}">
            ...
            <li class="relative">
                ...
                <ul x-show="selected == 1" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal">
                    ...
                    <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="{{route('milestone.index')}}">Milestones</a>
                    </li>
                ...
                <li class="relative">
                    <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                        <div class="flex-shrink max-w-full px-4 w-1/3">
                            <img src="{{asset('src/img/avatar/avatar.png')}}" class="h-10 w-10 rounded-full" alt>
                        </div>
                        <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                            <div class="font-bold"><a href="#"
                                                      class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500">{{\Illuminate\Support\Str::limit(auth()->user()->name,10)}}</a></div>
                            <div class="text-gray flex-wrap text-sm mt-1">{{auth()->user()->email}}.</div>
                        </div>
                    </div>
                </li>
                <li class="relative">
